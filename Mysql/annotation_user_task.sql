...
CREATE TABLE `user_task` (
  ...
  `user_t_task_id` int NOT NULL,
  `user_user_id` int NOT NULL,
  `assigned_date` date NOT NULL,
  `latest_assign_date` date NOT NULL,
  PRIMARY KEY (`user_task_id`),
  KEY `user_t_task_id_idx` (`user_t_task_id`),
  KEY `user_user_id_idx` (`user_user_id`),
  CONSTRAINT `user_t_task_id` FOREIGN KEY (`user_t_task_id`) REFERENCES `task` (`task_id`),
