...
CREATE TABLE `analytic` (
  ...
  `analytic_user_id` int NOT NULL,
  `classification_text` longtext NOT NULL,
  `classification_class` tinyint NOT NULL,
  `file_path` longtext,
  PRIMARY KEY (`classification_id`),
  KEY `user_id_idx` (`analytic_user_id`),
  CONSTRAINT `analytic_user_id` FOREIGN KEY (`analytic_user_id`) REFERENCES `user` (`user_id`)
